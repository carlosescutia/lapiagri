        ...
        <div style="min-height: 46vh">
            <div class="row">
                <div class="col-sm-10">
                    <div class="row">
                        ...
                        <div class="col-sm-3 align-self-center">
                            <p class="small"><strong>Cargo</strong></p>
                        </div>
                        <div class="col-sm-2 align-self-center">
                            <p class="small"><strong>Región</strong></p>
                        </div>
                        <div class="col-sm-2 align-self-center">
            ...
            <div class="row">
                ...
                <div class="col-sm-10 alternate-color">
                    <div class="row">
                        <div class="col-sm-1 align-self-center">
                            <p><?= $empleados_item['cve_empleado'] ?></p>
                        </div>
                        <div class="col-sm-3 align-self-center">
                            <p><a href="<?=base_url()?>empleados/detalle/<?=$empleados_item['cve_empleado']?>"><?= $empleados_item['nom_empleado'] ?></a></p>
                        </div>
                        <div class="col-sm-3 align-self-center">
                            <p><?= $empleados_item['cargo'] ?></p>
                        </div>
                        <div class="col-sm-2 align-self-center">
                            <p><?= $empleados_item['region'] ?></p>
                        </div>
                        <div class="col-sm-2 align-self-center">
                            <p><?= $empleados_item['estado'] ?></p>
                        </div>
                        <div class="col-sm-1">
                            <?php 
